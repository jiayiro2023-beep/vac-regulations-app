      ...
      <div className="mx-auto max-w-[860px]">
        <div className="mb-2.5 flex flex-wrap items-end justify-between gap-3">
          <div className="min-w-0">
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-blue-600 dark:text-blue-300">Search the regulations</p>
            <h2 className="mt-1 text-base font-extrabold text-slate-800 dark:text-slate-100 sm:text-[18px]">搜尋法規全文</h2>
          </div>
        ...
        <div className="relative flex items-center">
          ...
          {keyword ? (
            ...
            <span className="pointer-events-none absolute right-3 hidden rounded-lg bg-slate-100 px-2 py-1 text-xs font-semibold text-slate-500 dark:bg-slate-800 dark:text-slate-400 sm:inline-flex">全文搜尋</span>
          )}
        </div>

        <div className="mt-2.5 flex min-h-5 items-center justify-between gap-2">
          <span className="truncate text-xs font-medium text-slate-400 dark:text-slate-500 sm:text-[14px]">目前範圍：{scopeLabel}</span>
          {keyword && (
